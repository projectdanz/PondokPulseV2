export const SIDEBAR_MENU = {
    Manager: [
        ...
        {id: 3,label: "KPI", path: "/dashboard/manager/kpi"},
    ...
    Koordinator: [
        ...
        {id: 2,label: "Absensi", path: "/dashboard/koordinator/absensi"},
        {id: 3,label: "Karyawan", path: "/dashboard/koordinator/karyawan"},
    ],

    Karyawan: [
        {id: 1,label: "Home" ,path: "/dashboard/karyawan"},
        {id: 2,label: "Absensi", path: "/dashboard/karyawan/absensi"},
    ]
}